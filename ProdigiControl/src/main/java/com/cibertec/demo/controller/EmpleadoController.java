...
import com.cibertec.demo.service.EmpleadoService;
import com.cibertec.demo.util.pagination.PageRender;
import com.cibertec.demo.util.report.EmpleadoExporterExcel;
import com.cibertec.demo.util.report.EmpleadoExporterPDF;
...
public class EmpleadoController {
    ...
    public String listarEmpleados(@RequestParam(name = "page", defaultValue = "0") int page, Model modelo) {
        ...
        PageRender<Empleado> pageRender = new PageRender<>("/listar_empleado", empleados);
